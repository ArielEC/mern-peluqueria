...
\begin{itemize}
    ...
    \item \textbf{Tasa de conversi\'on:} Número de citas completadas sobre el total de citas no canceladas.
\end{itemize}

Adem\'as, incluye un \textit{widget} con un listado de las citas m\'as próximas.

\subsection{Calendario}\label{subsec:calendario}

El calendario interactivo permite visualizar la agenda completa del negocio. Ofrece dos vistas: semanal y diaria. En la vista diaria, cada profesional aparece como una columna independiente (vista de recursos), lo que permite ver la ocupaci\'on de cada uno de forma simult\'anea. Las citas se muestran con el color asignado al profesional y pueden consultarse en detalle haciendo clic sobre ellas. El administrador puede crear nuevas citas manualmente desde el propio calendario.
